...
//XMLEntities
$g_XMLEntities = array();
$g_XMLEntities[] = new TPG_XmlEntity(0x26, "&amp;");
$g_XMLEntities[] = new TPG_XmlEntity(0x22, "&quot;");
$g_XMLEntities[] = new TPG_XmlEntity(0x27, "&apos;");
$g_XMLEntities[] = new TPG_XmlEntity(0x3c, "&lt;");
$g_XMLEntities[] = new TPG_XmlEntity(0x3e, "&gt;");

abstract class TPG_Nullable
{
...
class TPG_NullableInt extends TPG_Nullable
{
    private $m_nValue;
...
class TPG_NullableBool extends TPG_Nullable
{
    private $m_boValue;
...
class TPG_ISOCountryList
{
    ...
    public function getISOCountry($szCountry, &$icISOCountry)
    {
        ...
        while ($nCount < count($this -> m_licISOCountries))
        {
            ...
            {
                $icISOCountry = new TPG_ISOCountry($icISOCountry2 -> getISOCode(), $icISOCountry2 -> getCountryShort2(), $icISOCountry2 -> getCountryShort3(), $icISOCountry2 -> getCountryName(), $icISOCountry2 -> getListPriority());
                $boFound = true;
                break;
            }
    ...
    {
        $newISOCountry = new TPG_ISOCountry($nISOCode, $szCountryShort2, $szCountryShort3, $szCountryName, $nListPriority);
...
class TPG_ISOCurrencyList
{
    ...
    public function getISOCurrency($vCurrency, &$icISOCurrency)
    {
        ...
        while (!$boFound && $nCount < count($this -> m_licISOCurrencies))
        {
            ...
            {
                $icISOCurrency = new TPG_ISOCurrency($icISOCurrency2 -> getISOCode(), $icISOCurrency2 -> getCurrency(), $icISOCurrency2 -> getCurrencyShort(), $icISOCurrency2 -> getExponent());
                $boFound = true;
            }
    ...
    {
        $newISOCurrency = new TPG_ISOCurrency($nISOCode, $szCurrency, $szCurrencyShort, $nExponent);
...
class TPG_XmlAttribute2
{
    ...
    {
        $xaXmlAttribute = new TPG_XmlAttribute($this -> m_szName, $this -> m_szValue);

        return $xaXmlAttribute;
    }

}
class TPG_XmlAttribute2List
{
    ...
    public function add(TPG_XmlAttribute2 $xaXmlAttribute)
    {
...
class TPG_XmlTag2
{
    ...
    public function __construct()
    {
        $this -> m_xalXmlAttributes = new TPG_XmlAttribute2List();
        $this -> m_xtlChildTags = new TPG_XmlTag2List();
    }

    public function toXmlTag()
    {
        $xtXmlTag = new TPG_XmlTag($this -> m_szName, $this -> m_szContent, $this -> m_xtlChildTags -> toListOfXmlTagObjects(), $this -> m_xalXmlAttributes -> toListOfXmlAttributeObjects());

        return $xtXmlTag;
    }

}
class TPG_XmlTag2List
{
    ...
    public function add(TPG_XmlTag2 $xtXmlTag)
    {
        if ($xtXmlTag != null)
        {
...
class TPG_XmlTag
{
    ...
    public function __construct($szName, $szContent, $lxtChildTags, $lxaXmlAttributes)
    {
        $this -> m_szName = $szName;
        $this -> m_szContent = $szContent;
        $this -> m_xalXmlAttributes = new TPG_XmlAttributeList($lxaXmlAttributes);
        $this -> m_xtlChildTags = new TPG_XmlTagList($lxtChildTags);
    }

}
class TPG_XmlTagList
{
    private $m_lxtXmlTagList;
    ...
    public function getXmlTag($szName)
    {
        ...
        $lszHierarchicalNames = TPG_SharedFunctions::getStringListFromCharSeparatedString($szName, '.');
    ...
    public function getValue($szXMLVariable, &$szValue)
    {
        ...
        $lszHierarchicalNames = new TPG_StringList();
        $szValue = null;
        $lszHierarchicalNames = TPG_SharedFunctions::getStringListFromCharSeparatedString($szXMLVariable, '.');
        ...
        if ($lszHierarchicalNames -> getCount() == 1)
        {
            ...
            if ($xtCurrentTag != null)
            {
                ...
                if ($xaXmlAttribute != null)
                {
                    $szValue = TPG_SharedFunctions::replaceEntitiesInStringWithChars($xaXmlAttribute -> getValue());
                    $boReturnValue = true;
                }
                else
                {
                    $szValue = TPG_SharedFunctions::replaceEntitiesInStringWithChars($xtCurrentTag -> getContent());
                    $boReturnValue = true;
                }
            }
        }
...
class TPG_XmlParser
{
    ...
    public function parseBuffer($szXmlString)
    {
        ...
        try
        {
            ...
            $xtlXmlTagList = TPG_XmlParser::toXmlTagList($sxiSimpleXMLIterator);
            $this -> m_xtlXmlTagList = new TPG_XmlTagList($xtlXmlTagList -> toListOfXmlTagObjects());
    ...
    private static function toXmlTagList(SimpleXMLIterator $sxiSimpleXMLIterator)
    {
        ...
        for ($sxiSimpleXMLIterator -> rewind(); $sxiSimpleXMLIterator -> valid(); $sxiSimpleXMLIterator -> next())
        {
            ...
            {
                $xaXmlAttribute = new TPG_XmlAttribute2();
            ...
            {
                $xtlChildXmlTagList = TPG_XmlParser::toXmlTagList($sxiSimpleXMLIterator -> current());
...
class TPG_SharedFunctions
{
    public static function getStringListFromCharSeparatedString($szString, $cDelimiter)
    {
        ...
        $lszStringList = new TPG_StringList();
